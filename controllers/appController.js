...
export async function generateOTP(req, res) {
    ...
    //here iam avoiding  unwanted alphabets letters.
...
export async function verifyOTP(req, res) {
    ...
    const { code } = req.query;   // from this query we accessing the otp

    if (parseInt(req.app.locals.OTP) === parseInt(code)) {  // fixing for the integer count
